...
def motley_cue_options(func):
    ...
    @optgroup.option("--mc-endpoint", metavar="URL", callback=validate_pass_from_parent,
    ...
    @optgroup.option("--insecure", "verify", is_flag=True, default=True, callback=validate_verify,
                  help="Ignore verifying the SSL certificate for motley_cue endpoint, NOT RECOMMENDED.")
    @optgroup.option("--no-cache", is_flag=True, default=False, callback=validate_pass_from_parent,
